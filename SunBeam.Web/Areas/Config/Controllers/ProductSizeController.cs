...
namespace SunBeam.Web.Areas.Config.Controllers
{
    ...
    {
        private readonly IProductSizeBL repo;
        public ProductSizeController(IProductSizeBL _repo)
        {
            this.repo = _repo;
        }
        ...
        public async Task<ActionResult> Create(ProductSize data)
        {
            ...
            try
            {
                result = await repo.InsertProductSize(data);
            }
            catch (Exception ex)
            {
                throw;
        ...
        public ActionResult Edit(int Id)
        {
            ...
            try
            {
                data = repo.GetProductSizeById(Id).Result;
            }
            catch (Exception ex)
            {
                throw;
        ...
        public async Task<JsonResult> DropDownProductSize()
        {
            dynamic result;
            try
            {
                result = await repo.DropDownProductSize();
            }
            catch (Exception ex)
            {
                throw ex;
