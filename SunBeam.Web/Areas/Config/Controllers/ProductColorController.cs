...
namespace SunBeam.Web.Areas.Config.Controllers
{
    public class ProductColorController : Controller
    {
        ...
        public ProductColorController(IProductColorBL _repo)
        {
            this.repo = _repo;
        }
        ...
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            var getAllData = repo.GetAllProductColor().Result;
            IEnumerable<ProductColor> filteredData;
            ...
            Func<ProductColor, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
