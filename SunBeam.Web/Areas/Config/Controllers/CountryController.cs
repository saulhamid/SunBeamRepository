...
namespace SunBeam.Web.Areas.Config.Controllers
{
    public class CountryController : Controller
    {
        ...
        public CountryController(IEnumCountryBL _repo)
        {
            this.repo = _repo;
        }
        // GET: Config/Country
        ...
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            var getAllData = repo.GetAllEnumCountry().Result;
            IEnumerable<EnumCountry> filteredData;
            ...
            Func<EnumCountry, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        public async Task<JsonResult> DropDownCountry()
        {
            dynamic result;
            try
            {
