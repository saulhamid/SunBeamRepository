...
namespace SunBeam.Web.Areas.Config.Controllers
{
    public class ProductBrandController : Controller
    {
        ...
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            var getAllData = repo.GetAllProductBrands().Result;
        ...
        [HttpPost]
        public async Task<ActionResult> Create(ProductBrand data)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(ProductBrand data)
        {
            string result = string.Empty;
            try
            {
