...
namespace SunBeam.Data.Repositories.Implementations
{
    ...
    public class ProductBrandsRepository : DBGeneric<ProductBrand>, IRepository<ProductBrand>
    {
        ...
        public async Task<string> Insert(ProductBrand entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns>Message</returns>
        public async Task<string> Update(ProductBrand entity)
        {
            try
            {
                var cmd = new SqlCommand("sp_ProductBrands");
        ...
        /// <param name="Id"></param>
        /// <returns>Message</returns>
        public async Task<string> IsDelete(int Id, ProductBrand entity)
        {
            try
            {
                var cmd = new SqlCommand("sp_ProductBrands");
        ...
        /// <returns>ProductBrands Object</returns>
        public ProductBrand Mapping(SqlDataReader reader)
        {
            try
            {
                ProductBrand oProductBrands = new ProductBrand();
        ...
        /// </summary>
        /// <returns>List ofProductBrands</returns>
        public async Task<IEnumerable<ProductBrand>> Dropdown()
        {
            try
            {
                var cmd = new SqlCommand("sp_ProductBrands");
