...
namespace SunBeam.Service.Interfaces
{
    ...
    public class ProductBrandsBL : IProductBrandsBL
    {
        ...
        public async Task<string> InsertProductBrands(ProductBrand entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns>Message</returns>
        public async Task<string> UpdateProductBrands(ProductBrand entity)
        {
            try
            {
        ...
        /// <param name="Id"></param>
        /// <returns>Message</returns>
        public async Task<string> IsDeleteProductBrands(string[] IdList, ProductBrand entity)
        {
        ...
        public async Task<ProductBrand> GetProductBrandsById(int Id)
        {
            try
            {
        ...
        /// </summary>
        /// <returns>List ofProductBrands</returns>
        public async Task<IEnumerable<ProductBrand>> DropDownProductBrands()
        {
            try
            {
