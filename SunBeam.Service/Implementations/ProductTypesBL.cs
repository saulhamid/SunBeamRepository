...
public async Task<string> InsertProductTypes(ProductType entity)
{
try
{
...
/// <param name="entity"></param>
/// <returns>Message</returns>
public async Task<string> UpdateProductTypes(ProductType entity)
{
try
{
...
/// <param name="Id"></param>
/// <returns>Message</returns>
public async Task<string> IsDeleteProductTypes(string[] IdList, ProductType entity)
{
...
public async Task<ProductType> GetProductTypesById(int Id)
{
try
{
...
/// </summary>
/// <returns>List ofProductTypes</returns>
public async Task<IEnumerable<ProductType>> DropDownProductTypes()
{
try
{
