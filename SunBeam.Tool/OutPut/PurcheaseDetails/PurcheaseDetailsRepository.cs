...
cmd.Parameters.AddWithValue("@CreatedAtBy", entity.CreatedAtBy);
...
oPurcheaseDetails.TotalPrice = Helper.ColumnExists(reader, "TotalPrice") ? ((reader["TotalPrice"] == DBNull.Value) ? 0 : Convert.ToDecimal(reader["TotalPrice"])) : 0;
...
oPurcheaseDetails.CreatedAtBy = Helper.ColumnExists(reader, "CreatedAtBy") ? reader["CreatedAtBy"].ToString() : "";
