...
public class ProductCategorysRepository : DBGeneric<ProductCategorys>, IRepository<ProductCategorys>
{
...
/// <returns>ProductCategorys Object</returns>
public ProductCategorys Mapping(SqlDataReader reader)
{
try
{
ProductCategorys oProductCategorys = new ProductCategorys();
