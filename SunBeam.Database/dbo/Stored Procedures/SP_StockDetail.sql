...
CREATE proc  [dbo].[SP_StockDetail]
(
@Id int=null
,@ProductId int = null
...
, CreatedFrom  )
     VALUES
           ( @SalesId, @SalesReturnId, @PurcheaseId, @PurcheaseReturnId, @StockId, 
		   @TotalReplace1, 
...
begin
select @StockId=Id, @TotalQuantity1=Quantity,@Date1=Date,@FinalUnitPrice1=FinalUnitPrice,@TotalPaid1=TotalPaid from dbo . Stocks  where ProductId=@ProductId
update StockDetails set
SalesId=@SalesId
,SalesReturnId=@SalesReturnId
,PurcheaseId=@PurcheaseId
,PurcheaseReturnId=@PurcheaseReturnId
,StockId=@StockId
,StockReplace=@TotalReplace1 
,TransReplace=@TotalReplace-@TotalReplace1
,TotalReplace=@TotalReplace
,StockReturn=@TotalReturn1
,TransReturn=@TotalReturn-@TotalReturn1
,TotalReturn=@TotalReturn
,StockDiscount=@TotalDiscount1
,TransDiscount=@TotalDiscount-@TotalDiscount1
,TotalDiscount=@TotalDiscount
,TransSlup=@TotalSlup1
,StockSlup=@TotalSlup-@TotalSlup1
,TotalSlup=@TotalSlup
,StockQuantity=@TotalQuantity1
,TransQuantity=@TotalQuantity+@TotalQuantity1
